...
import { CANCEL_ROOM, FINISH_ROOM } from '../../constants/action'
    ...
    return (
      <div className="notification-container">
      	<div className="notification">
      		<h3>Your turn at {urgentRooms[0]} </h3>
      		<div className="img-container">
      			<img src="https://i.imgur.com/Zi385Mr.png"/>
      		</div>
      		<div className="button-group">
      			<button 
      				onClick={this.cancelBooking(urgentRooms[0])}
      				className="waves-effect waves-light btn btn-warning">
      				Cancel
      			</button>
      			<button
      				onClick={this.finishBooking(urgentRooms[0])}
